...
?>
    <div class="rounded-full sm:h-40 sm:w-40 h-28 w-28 border cursor-pointer overflow-hidden relative bg-black" data-perso=<?= $value->getId() ?> data-name="<?= $value->getNom() ?>">
