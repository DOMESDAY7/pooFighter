<?php
                        ...
                        <?php foreach ($tab as $value) { ?>
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= "?idDelete=" . $value->getId() ?>&modal=true"><button class="bg-red-50 text-red-600 rounded-full p-2 m-3">
                                                <lord-icon src="https://cdn.lordicon.com/gsqxdxog.json" trigger="hover" colors="primary:#911710,secondary:#911710">
                                                </lord-icon>
                                            </button></a>

                                        <a href="<?= "?idMod=" . $value->getId() ?>&modalMod=true"><button class="bg-teal-100 text-teal-900 rounded-full p-2 m-3">
                                                <lord-icon src="https://cdn.lordicon.com/sbiheqdr.json" trigger="hover" colors="primary:#109173,secondary:#109173">
                                                </lord-icon>
                                            </button></a>
                                    </td>
                                </tr>
    ...
    <form method="POST" class="border rounded-lg mt-10 text-center ">
        <div class="my-10">
            ...
            <input type="text" name="pv" placeholder="le nombre de point de vie de votre personnage" class="border rounded mb-5 p-3"><br>
            <button type="submit" name="subAdd" class="text-white bg-zinc-800 rounded p-3">Créé un nouveau personnage <lord-icon
                ...
                <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                        ...
                        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                            ...
                            <!-- <button type="submit" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm"name="subMod" >Modifie le personnage</button> -->
